...
PRODUCT_COPY_FILES += \
        device/lge/geeb/wifi/WCNSS_cfg.dat:system/vendor/firmware/wlan/prima/WCNSS_cfg.dat \
        device/lge/geeb/wifi/WCNSS_qcom_cfg.ini:system/etc/wifi/WCNSS_qcom_cfg.ini \
        device/lge/geeb/wifi/WCNSS_qcom_wlan_nv.bin:system/etc/wifi/WCNSS_qcom_wlan_nv.bin \
        device/lge/geeb/wifi/wpa_supplicant_overlay.conf:system/etc/wifi/wpa_supplicant_overlay.conf \
        device/lge/geeb/wifi/p2p_supplicant_overlay.conf:system/etc/wifi/p2p_supplicant_overlay.conf \
...
#dalvik tweaks
PRODUCT_PROPERTY_OVERRIDES += \
dalvik.vm.dexopt-flags=v=n,o=a,u=n \
